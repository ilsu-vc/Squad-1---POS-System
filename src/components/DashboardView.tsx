                ...
                <div className="stats-grid">
                    <div className="stat-card">
                        ...
                        <div className="stat-icon-bg">
                            <img src={typeof total_revenue_icon === 'string' ? total_revenue_icon : (total_revenue_icon as any).src} alt="" className="stat-img-icon" />
                        </div>
                    </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-icon-bg">
                            <img src={typeof transaction_icon === 'string' ? transaction_icon : (transaction_icon as any).src} alt="" className="stat-img-icon" />
                        </div>
                    </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-icon-bg">
                            <img src={typeof avg_transaction === 'string' ? avg_transaction : (avg_transaction as any).src} alt="" className="stat-img-icon" />
                        </div>
                    </div>
                    ...
                    <div className="stat-card">
                        ...
                        <div className="stat-icon-bg">
                            <img src={typeof items_sold_icon === 'string' ? items_sold_icon : (items_sold_icon as any).src} alt="" className="stat-img-icon" />
                        </div>
                    </div>
                </div>
