/**
 * src/app/api/transactions/[...path]/route.ts
 * Next.js API gateway — proxies all /api/transactions/* requests to transaction-service.
 */
import { NextRequest, NextResponse } from 'next/server';

const SERVICE_URL = process.env.POS_FRONTEND_TRANSACTION_SERVICE_URL || 'http://localhost:3038';
